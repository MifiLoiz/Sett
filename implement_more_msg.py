...
# Hij crashde volgensmij omdat hij niet wist hoe hij verschil tussen image en tekst moest detecten
        ...
        if self.computer_last_set_indices and time.time() < self.computer_pause_end:
            ...
            self.screen.blit(comp_png, (250 + 100, 375))  # draws the card image with a small margin 
            ...
            self.screen.blit(comp_surface, (DISPLAY_WIDTH // 2 - comp_surface.get_width() // 2 + 100, DISPLAY_HEIGHT - 110))   # tweede coordinaat was: DISPLAY_HEIGHT - 60
